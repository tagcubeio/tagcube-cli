...
version=`python -c 'from tagcube import __VERSION__;print __VERSION__,'`
curl -f -s -S -k -X GET -I https://pypi.python.org/packages/source/t/tagcube-cli/tagcube-cli-$version.tar.gz
